 ...
 * object. Once attached, the queue converts the target
...
/**
 * Attempt to create an queue instance for a value,
 * returns the new queue if successfully observed,
 * or the existing queue if the value already has one.
 */
...
function lifecycleMixin (Vue) {
  ...
  Vue.prototype.$destroy = function () {
    ...
    // frozen object may not have queue.
    if (vm._data.__ob__) {
